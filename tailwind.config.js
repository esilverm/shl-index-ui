...
module.exports = {
  ...
  theme: {
    colors: {
      ...
      boxscoreTextDarkGrey: 'rgba(var(--boxscoreTextDarkGrey))',
      grey650Dark: 'rgba(var(--grey650Dark))',
      boxscoreTextLightGrey: 'rgba(var(--boxscoreTextLightGrey))',
      globalBorderGrey: 'rgba(var(--globalBorderGrey))',
      boxscoreTeamRosterGrey: 'rgba(var(--boxscoreTeamRosterGrey))',
