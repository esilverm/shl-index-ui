        ...
        <React.Fragment key={`goalie_${goalie.name}_${i}`}>
          ...
          <Skeleton isLoaded={!isLoading}>
            <div className="mb-3 flex w-full items-center justify-between">
              <div className="flex flex-col font-mont text-sm text-LabelHeadings dark:text-grey100TextDark">
                <span>{statLabels.record}</span>
                <span className="font-semibold text-grey600 dark:text-grey100TextDark">
              ...
              {Object.keys(goalie).map((stat, i) => {
                ...
                return (
                  <div
                    className="flex flex-col font-mont text-sm text-LabelHeadings dark:text-grey100TextDark"
                  ...
                  {Object.keys(statLabels).map((stat, i) => {
                    ...
                    return (
                      <div
                        ...
                        key={`${stat}_${i}`}
                      >
                        <div className="flex-1 break-words font-semibold text-grey600 dark:text-grey100TextDark">
                          {awayGoalie &&
                            (currentStat === 'record'
                        ...
                        <span className="font-semibold text-LabelHeadings dark:text-LabelHeadingsDark">
                          {statLabels[currentStat]}
                        </span>
                        <div className="flex-1 break-words text-right font-semibold text-grey600 dark:text-grey100TextDark">
                          {homeGoalie &&
                            (currentStat === 'record'
