        ...
        <React.Fragment key={`goalie_${goalie.name}_${i}`}>
          ...
          <Skeleton isLoaded={!isLoading}>
            <div className="mb-3 flex w-full items-center justify-between">
              <div className="flex flex-col font-mont text-sm text-LabelHeadings dark:text-LabelHeadingsDark">
                <span>{statLabels.record}</span>
                <span className="font-semibold text-grey600 dark:text-grey600Dark">
              ...
              {Object.keys(goalie).map((stat, i) => {
                ...
                return (
                  <div
                    className="flex flex-col font-mont text-sm text-LabelHeadings dark:text-LabelHeadingsDark"
                  ...
                  {Object.keys(statLabels).map((stat, i) => {
                    ...
                    return (
                      <div
                        ...
                        key={`${stat}_${i}`}
                      >
                        <div className="flex-1 break-words font-semibold text-grey600 dark:text-grey600Dark">
                          {awayGoalie &&
                            (currentStat === 'record'
                        ...
                        <div className="flex-1 break-words text-right font-semibold text-grey600 dark:text-grey600Dark">
                          {homeGoalie &&
                            (currentStat === 'record'
