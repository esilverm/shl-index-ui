          ...
          cell: (props) => {
            ...
            return (
              ...
              >
                ...
                />
                <span className="inline text-left text-hyperlink dark:text-hyperlink md:hidden">
                  {cellValue[1]}
                </span>
                <span className="my-0 mx-2.5 hidden min-w-max text-left text-hyperlink dark:text-hyperlink md:inline">
                  {cellValue[2]}
                </span>
              </Link>
            );
