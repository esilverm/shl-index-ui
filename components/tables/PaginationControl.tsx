...
export const PaginationControl = <T extends Record<string, unknown>>({
  ...
  return (
    <div className="flex w-full items-center justify-between space-x-3 rounded-b-lg border border-t-0 border-grey500 py-2 px-4 dark:border-grey500Dark lg:space-x-10">
      <Tooltip
