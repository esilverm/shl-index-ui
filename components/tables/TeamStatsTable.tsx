          ...
          cell: (props) => {
            ...
            return (
              ...
              >
                ...
                />
                <span className="ml-1.5 text-left text-blue600 dark:text-hyperlink md:hidden">
                  {cellValue[1]}
                </span>
                <span className="my-0 mx-2.5 hidden min-w-max text-left text-blue600 dark:text-hyperlink md:inline">
                  {cellValue[0]}
                </span>
              </Link>
            );
