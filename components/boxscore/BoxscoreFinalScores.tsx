...
const TeamFinalScoreRow = ({
  ...
  <div
    className={classnames(
      ...
      team === 'away' && 'border-b-2 border-b-grey200 dark:border-b-boxscoreBorderGrey',
    )}
  >
...
export const BoxscoreFinalScores = ({
  ...
  return (
    <div className="flex w-full flex-col bg-grey100 px-4 pb-2 dark:bg-backgroundGrey100">
      <div className="flex w-full items-center border-b-2 border-b-grey300 py-2.5 font-mont text-xs dark:border-b-globalBorderGrey">
