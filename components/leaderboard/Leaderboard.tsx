            ...
            >
              <div
                className={classnames(
                  'relative flex min-h-[30px] items-center  border-b-2 border-b-grey300 dark:border-b-grey300Dark',
...
const StatVisualizer = ({
  ...
  return (
    <div
      className="absolute h-full bg-grey700 opacity-10 dark:bg-grey700Dark"
      style={{
