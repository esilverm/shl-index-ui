...
export default ({ league }: { league: League }) => {
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full bg-grey100 p-[2.5%] dark:bg-backgroundGrey100 lg:w-3/4 lg:pt-px lg:pb-10">
        {isLoading ? (
          ...
          <>
            <div className="flex flex-col items-center md:mr-8 md:flex-row md:justify-end">
              <SeasonTypeSelector className="top-7 !h-7 w-48 dark:border-white dark:text-white" />
            </div>
