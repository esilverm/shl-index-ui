...
export default ({ league }: { league: League }) => {
  return (
    <>
      ...
      <div className="my-0 mx-auto block h-auto w-full flex-1 grid-cols-4 grid-rows-6 gap-6 bg-grey100 p-6 dark:bg-backgroundGrey100 lg:grid xl:w-3/4">
        ...
        <div className="col-start-4 col-end-5 row-start-1 row-end-7 divide-y-2 divide-grey300 dark:divide-white">
