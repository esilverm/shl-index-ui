...
export default ({ league }: { league: League }) => {
  return (
    <>
      ...
      <div className="mx-auto my-0 block h-auto w-full flex-1 grid-cols-4 grid-rows-6 gap-6 bg-primary p-6 lg:grid xl:w-3/4">
        ...
        <div className="col-start-4 col-end-5 row-start-1 row-end-7 divide-y-2 divide-secondary">
